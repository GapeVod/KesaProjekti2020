...
#from my_own_character import MyOwnCharacter
...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        self._create_fleet()
        #self.character = MyOwnCharacter(self)
    ...
    def _create_fleet(self):
        ...
        available_space_x = self.settings.screen_width - (random_number * alien_width)
        number_aliens_x = available_space_x // (2 * alien_width)

        #Determine the number of rows of aliens that fit on the screen.
        ship_height = self.ship.rect.height
        available_space_y = (self.settings.screen_height -
            (random_number * random_number) - ship_height)
